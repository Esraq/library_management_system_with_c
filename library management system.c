...
fclose(fp);
remove("eisty.dat");
rename("test.dat","eisty.dat"); //copy all item from temporary file to fp except that
fp=fopen("eisty.dat","rb+");    //we want to delete
if(findbook=='t')
{
gotoxy(10,10);
...
gotoxy( 15,20);
printf("Enter Your Choice");
fp=fopen("eisty.dat","rb+"); //open file for reading propose
